...
<head>
  ...
  <div class="container">
    ...
    <div class="container" style="border-radius: 25px;background-color: rgba(163, 173, 160, 0.3);padding: 20px">
      <form action="/garage/create" method="POST">
        {{method_field('POST')}}
        {{@csrf_field()}}
          ...
          <div class="form-group">
            ...
            <input name="kapasitas" type="text" class="form-control" id="examplenama" placeholder="Nama"  >
          </div>

          <div class="form-group">
            <label for="examplenama">Harga</label>
            <input name="harga" type="text" class="form-control" id="examplenama" placeholder="Nama"  >
          </div>

          <div class="form-group">
            <label for="examplenama">Detail</label>
            <input name="verifikasi" type="text" class="form-control" id="examplenama" placeholder="Nama"  >
          </div>
